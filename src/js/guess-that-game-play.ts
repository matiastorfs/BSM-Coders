async function init() {
  ...
  const imgContainer = document.getElementById("imgGame") as HTMLInputElement;
  const form = document.getElementById("guessForm") as HTMLInputElement;
  const input = document.getElementById("guessInput") as HTMLInputElement;
  const title = document.getElementById("title") as HTMLInputElement;

  const xpDisplay = document.getElementById("xp") as HTMLElement;
  ...
  form.addEventListener("submit", function (e) {
    ...
    if (guess === correctName) {
      ...
      xpDisplay.textContent = xp.toString();
      progressDisplay.textContent = correctAnswers.toString();
